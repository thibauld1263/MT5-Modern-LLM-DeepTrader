...
//--- Input parameters
input string   InpSymbols    = "EURUSD,GBPUSD,AUDUSD,NZDUSD,USDCAD,USDCHF,USDJPY,USDSGD,"
                                "EURJPY,EURGBP,EURAUD,EURCAD,EURCHF,EURNZD,"
                                "GBPAUD,GBPCAD,GBPCHF,GBPJPY,GBPNZD,"
                                "AUDCAD,AUDCHF,AUDJPY,AUDNZD,"
                                "NZDCAD,NZDCHF,NZDJPY,"
                                "CADCHF,CADJPY,CHFJPY,"
                                "AAPL.NAS,AMZN.NAS,GOOG.NAS,MSFT.NAS,NVDA.NAS,TSLA.NAS,"
                                "BA.NYSE,JNJ.NYSE,JPM.NYSE,KO.NYSE,XOM.NYSE,"
                                "AUS200,CHINA50,DE40,F40,JP225,STOXX50,UK100,US2000,US30,US500,USTEC,"
                                "XAUUSD,XAUEUR,XAUAUD,XAUCHF,XAUGBP,XAUJPY,"
                                "XAGUSD,XAGAUD,XAGEUR,XPDUSD,XPTUSD,"
                                "BTCUSD";                               // 63 Symbols
input datetime InpStartDate  = D'2000.01.01 00:00';         // Start date (max history)
input datetime InpEndDate    = D'2026.02.27 00:00';         // End date
